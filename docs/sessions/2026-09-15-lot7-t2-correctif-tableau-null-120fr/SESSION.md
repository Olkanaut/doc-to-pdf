...
--- A4/25mm pdftotext ---                      (160 mm de texte, template minimal/ministere)
Direction             Titulaires        Contractuels Total        Observationstemplate
...
$ npm test
 ✓ src/ai/parse.test.ts (5 tests) 1mstemplate
...
?? backend/src/convert/tableToTypst.test.tstemplate
